...
export default function AssignPermissionUserGroup({ assigned, setAssigned, userGroupPermissions }: AssignPermissionProps): React.JSX.Element {
    ...
    <>
      ...
      <Box className="flex ">
        <Box sx={{ maxHeight: 200, overflowY: 'auto' }}>
          ...
          >
            {userGroupPermissions?.map((tab, index) => (
              <Tab
                key={index}
